...
def render_overtime_calendar(username: str, team: str | None, read_only: bool) -> None:
    ...
    with month_col:
        st.markdown(
            f"<div class='yi-cal-month' style='text-align:center;font-size:1.7rem;"
            f"font-weight:700;color:#000000;-webkit-text-fill-color:#000000;"
            f"background:transparent;line-height:2.4rem;margin:0;'>"
            f"{month_cursor.year}년 {month_cursor.month}월</div>",
